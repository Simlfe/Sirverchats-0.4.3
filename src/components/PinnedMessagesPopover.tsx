        ...
        <div className="fixed inset-0 z-50 overflow-hidden pointer-events-none">
          ...
          <div className="fixed inset-0 z-50 flex items-start justify-center md:justify-end p-3 sm:p-4 pt-[calc(3.5rem+env(safe-area-inset-top,0px))] md:pt-16 pb-[max(1rem,env(safe-area-inset-bottom))] pointer-events-none select-none">
            <motion.div
              ...
              className="w-full max-w-sm sm:max-w-md rounded-2xl border shadow-2xl overflow-hidden pointer-events-auto flex flex-col max-h-[calc(100vh-5rem)] max-h-[calc(100dvh-5rem)] z-50 bg-[var(--theme-bg-card)] border-[var(--theme-border)] text-[var(--theme-text-primary)] pinned-messages-popover popover-menu-solid"
              dir={lang === 'ar' ? 'rtl' : 'ltr'}
            >
              {/* Header */}
