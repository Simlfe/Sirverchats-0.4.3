...
LEGACY_CHAT_SERVICE="${LEGACY_CHAT_SERVICE:-sirverchats-chat}"
CLOUDFLARED_SERVICE="${CLOUDFLARED_SERVICE:-cloudflared-sirverchats}"
...
LEGACY_CHAT_HEALTH_URL="${LEGACY_CHAT_HEALTH_URL:-http://127.0.0.1:8090/health}"
...
check_http_or_restart "${LEGACY_CHAT_SERVICE}" "${LEGACY_CHAT_HEALTH_URL}"
